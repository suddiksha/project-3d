            ...
            <div className="row justify-content-center about-row">
              <div className="col-12">
                <img
                  ...
                  alt="energy"
                  data-aos="fade-up"
                  ata-aos-duration="1200"
                ></img>
                <div
                  className="about-para pt-0 pb-0 text-center mt-5"
                  data-aos="fade-up"
                  ata-aos-duration="1400"
                >
