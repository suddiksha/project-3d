...
app.post('/api/sendmail', (req, res) => {
  ...
  const mailContent = {
    ...
    template: 'client_contact_Form', // Template filename (without extension)
  };
  ...
  const mailContent1 = {
    from: process.env.Email_User,
    to: rec_values.email, // User's email
    ...
    template: 'mailreceived', // Template filename (without extension)
  };
  ...
  transporter.sendMail(mailContent, (err) => {
    ...
    transporter.sendMail(mailContent1, (err) => {
      if (err) {
